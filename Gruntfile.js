...
module.exports = function (grunt) {
	...
	grunt.initConfig({
			...
			main: {
				files: [
					...
					},
					{
						...
						dest: 'dist/js/toastr.js'
					},
					{
						src: ['bower_components/toastr/toastr.css'],
						dest: 'dist/css/toastr.css'
					},
    			],
			},
		},
		uglify: {
			dist: {
				src: ['dist/js/jquery.js', 'dist/js/bootstrap.js', 'dist/js/toastr.js', 'dist/js/main.js'],
		...
		cssmin: {
			...
			target: {
				files: {
					"dist/css/main.min.css": ["dist/css/bootstrap.css", "dist/css/font-awesome.css", "dist/css/toastr.css", "/dist/css/main.css"]
				}
			}
		},
		clean: {
